$(function(){
	  ...
	  /* 工具栏 */
		...
		$('#DrawFlag').click(function() {
		   ...
		   $('#ClearSubmitPeople').click(function(){
		    	  ClearData();
		    });
		    $('#ClearSubmitVideo').click(function(){
		  	  ClearData();
		  });
		    $('#ClearSubmitEvent').click(function(){
		  	  ClearData();
		  });
		    $('#ClearSubmitBuild').click(function(){
		  	  ClearData();
		  });
		    $('#ClearSubmitPlace').click(function(){
		    	  ClearData();
		    });
})
function PointBox() {
