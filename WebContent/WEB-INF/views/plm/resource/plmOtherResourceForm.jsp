...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/resource/plmOtherResource/?type=03">他人的资源列表</a></li>
		<li class="active"><a
			href="${ctx}/resource/plmOtherResource/form?id=${plmResource.id}&type=03">他人的资源</a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="plmResource" style="margin: 0px 260px;"
		action="${ctx}/resource/plmOtherResource/save" method="post"
