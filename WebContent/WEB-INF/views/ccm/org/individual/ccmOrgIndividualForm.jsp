...
<body>
	...
	<form:form id="inputForm" modelAttribute="ccmOrgNpse" action="${ctx}/org/ccmOrgNpse/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
					...
					<div>
						...
						<div class="controls">
							<form:select path="compImpoType" class="input-xlarge required"  id="sel"  onchange="sels()" >
								<form:options items="${fns:getDictList('comp_impo_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						    	</form:select>
						</div>
					</div>
					...
					<div>
						...
						<div class="controls">
							<form:select path="regiType" class="input-xlarge ">
								<form:options items="${fns:getDictList('sys_ccm_regi_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						    </form:select>
						</div>
					</div>
				</td>
			...
			<tr>
				...
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="companyNum" htmlEscape="false" maxlength="6" class="input-xlarge number digits required"/>
						</div>
					</div>
				</td>
			</tr>
			...
			<tr>
				<td>
					<div>
						...
						<div class="controls">
							<form:select path="legalReprCode" class="input-xlarge " items="${fns:getDictList('sys_ccm_org_papers')}" 
				...
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="legalReprId" htmlEscape="false" maxlength="50" class="input-xlarge ident0 card required" />
						</div>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="legalReprTl" htmlEscape="false" maxlength="50" class="input-xlarge required phone" />
						</div>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="secuPhone" htmlEscape="false" maxlength="50" class="input-xlarge required phone" />
						</div>
					</div>
				</td>
				<td rowspan="20">
					...
					<div>
						...
						<div class="controls">
							<form:select path="holdCase" class="input-xlarge ">
								<form:options items="${fns:getDictList('ccm_hold_cond')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						    </form:select>
						</div>
					</div>
				</td>
			...
			<tr>
				...
				<td>
					<div>
						...
						<div class="controls">
							<form:radiobuttons path="estaOrga" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
						</div>
					</div>
				</td>
			</tr>
			<tr>
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="laborUnionNum" htmlEscape="false" maxlength="6" class="input-xlarge number digits required"/>
						</div>
					</div>
				</td>
				<td>
					<div>
						...
						<div class="controls">
							<form:radiobuttons path="laborUnion" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required" />
						</div>
					</div>
				</td>
			</tr>
			<tr>
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="youthLeagOrgaNum" htmlEscape="false" maxlength="6" class="input-xlarge number digits required"/>
						</div>
					</div>
				</td>
				<td>
					<div>
						...
						<div class="controls">
							<form:radiobuttons path="youthLeagOrga" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required" />
						</div>
					</div>
				</td>
			</tr>
			<tr>
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="womenNum" htmlEscape="false" maxlength="6" class="input-xlarge number digits required"/>
						</div>
					</div>
				</td>
				<td>
					<div>
						...
						<div class="controls">
							<form:radiobuttons path="womenOrg" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
						</div>
					</div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div>
						...
						<div class="controls">
							<form:radiobuttons path="dangComp" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
						</div>
					</div>
				</td>
			...
			<tr class="selectHidden">
				...
				<td>
					<div>
						...
						<div class="controls">
							<form:input path="survCameNum" htmlEscape="false" maxlength="5" class="input-xlarge number digits"/>
						</div>
					</div>
				</td>
			</tr>
			<tr class="selectHidden">
				...
				<td>
					<div>
						...
						<div class="controls">
							<form:radiobuttons path="xRayChec" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
						</div>
					</div>
				</td>
			</tr>
			<tr class="selectHidden">
				<td>
					<div>
						...
						<div class="controls">
							<form:radiobuttons path="checPack" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
						</div>
					</div>
				</td>
				<td>
					<div>
						...
						<div class="controls">
							<form:radiobuttons path="realName" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
						</div>
					</div>
				</td>
			</tr>
			<tr class="selectHidden">
				<td colspan="2">
					<div>
						...
						<div class="controls">
							<form:checkboxes path="manageScopeList" items="${fns:getDictList('ccm_busi_scope')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
						</div>
					</div>
				</td>
			</tr>
