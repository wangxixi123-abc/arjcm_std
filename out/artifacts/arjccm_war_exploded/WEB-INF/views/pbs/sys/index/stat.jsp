...
<html>
	...
	<body>
			...
			<div class="container-fluid height90">
				<div class="content row height100" style="height: 104%">
					<div class="col-xs-4 height100" style="margin-right: 0; padding-right: 0; margin-top: 7px;">
						<div class="col-xs-12 height33 Bordereffect">
							<div class="echarts" id="EchartsSex"></div>
						</div>
						<div class="col-xs-12 height33 Bordereffect">
							<div class="echarts" id="EchartsOccupation"></div>
						</div>
						<div class="col-xs-12 height53 Bordereffect">
							<div class="echarts" id="EchartsPeopleNumber"></div>
						</div>
					</div>

					<div class="col-xs-4 height100" style="margin-top: 7px;">
						<div class="col-xs-12 height33 margin0 Bordereffect">
							<div class="echarts" id="EchartsNumber"></div>
						</div>
						<div class="col-xs-12 height33 margin0 Bordereffect">
							<div class="echarts" id="EchartsoOrganization"></div>
						</div>
						<div class="col-xs-12 height53 margin0 Bordereffect">
							<div class="echarts" id="EchartsExamination"></div>
						</div>
					</div>

					<div class="col-xs-4 height100" style="margin-top: 7px;">
						<div class="col-xs-12 height33 margin0 Bordereffect">
							<div class="echarts" id="EchartsActivity1"></div>
						</div>
						<div class="col-xs-12 height33 margin0 Bordereffect">
							<div class="echarts" id="EchartsActivity2"></div>
						</div>
						<div class="col-xs-12 height53 margin0 Bordereffect">
							<div class="echarts" id="EchartsActivity3"></div>
						</div>
					</div>
		...
		src="${ctxStatic}/statis/js/commonMap.js"></script>-->
		<script>
	  		ctxStatic='${ctxStatic}'
	  		ctx = '${ctx}'
		</script>
		...
		<script type="text/javascript" src="${ctxStatic}/statis/js/index.js"></script>
