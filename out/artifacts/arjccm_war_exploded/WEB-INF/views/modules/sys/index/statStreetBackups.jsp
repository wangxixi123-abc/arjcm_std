...
<div class="container">
  <div class="header">
    ...
    <div class="header-right clearfix">
      <div></div>
      <q id="pTitle">您好,欢迎使用${fns:getConfig('showName')}“雪亮工程”综治平台！</q>
      <span><a href="${ctx}/logout" style="text-decoration: none"><i></i><font  style="color:#FFF;">退出</font></a></span>
       </div>
		<div>					
  ...
  <div class="main">
    <ul>
      ...
      <li>
        <h3 class="fatigue-duty">功能模块</h3>
        <div class="statistics"><img src="${ctxStatic}/common/index/images/win10/shipinronghe.png"/><a href="#" target="_blank" onclick="videoSubmit();"><b>视频融合</b></a></div>
        <div class="effectiveness"><img src="${ctxStatic}/common/index/images/win10/wanggehua.png"/><a href="${ctx}/sys/map/statIndexCom" target="_self"><b>网格化</b></a></div>
        <div class="scheduling"><img src="${ctxStatic}/common/index/images/win10/dangjian.png"/><a href="#" target="_blank" onclick="pbsSubmit();"><b>智慧党建</b></a></div>
        <div class="district"><img src="${ctxStatic}/common/index/images/win10/dianzishapan.png"/><a href="${fn:escapeXml(param.service)}${fn:indexOf(param.service, '?') eq -1 ? '?' : '&'}ticket=${serviceTicketId}" target="_self"><b>电子沙盘</b></a></div>
      </li>
      <li>
