...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/cms/ccmFontUser/cancelList">居民用户管理列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="ccmFontUser" action="${ctx}/cms/ccmFontUser/cancelList" method="post" class="breadcrumb form-search">
