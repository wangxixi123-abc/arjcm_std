...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/org/ccmOrgNpseSdyq/">数据列表</a></li>
		<li class="active"><a
			href="${ctx}/org/ccmOrgNpseSdyq/form?id=${ccmOrgNpse.id}">水电油气管理<shiro:hasPermission
					name="org:ccmOrgNpseSdyq:edit">${not empty ccmOrgNpse.id?'修改':'添加'}</shiro:hasPermission>
				<shiro:lacksPermission name="org:ccmOrgNpseSdyq:edit">查看</shiro:lacksPermission></a></li>
	...
	<form:form id="inputForm" modelAttribute="ccmOrgNpse"
		action="${ctx}/org/ccmOrgNpseSdyq/save" method="post"
