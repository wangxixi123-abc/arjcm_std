...
$(function () {
    ...
    function showWangGeGuanLi() {
        ...
        /*$('#echRightContent1').css("width", 50 + "%");
        $('#echRightContent1').css("height", divHeight + "px");
        $('#echRightContent1').css("float: left");
        $('#echRightContent1_1').css("width",  50 + "%");
        $('#echRightContent1_1').css("height", divHeight + "px");
        $('#echRightContent1_1').css("float: right");*/
    ...
    function hideDivChat(bool) {
        if (bool == 0) {
            ...
            $("#leftContent3").show();
            $("#leftContent4").hide();
            $("#rightContent1").find('.contentTitle').text('本月活动统计');
            $("#rightContent2").find('.contentTitle').text('本月事件统计');
            $("#rightContent3").find('.contentTitle').text('安全隐患统计');
            $("#rightContent0").hide();
            $("#rightContent1").show();
            $("#rightContent2").show();
            $("#rightContent3").show();
...
function resizeChat() {
    ...
    if (rightContent1Charts == null) {
        ...
        // rightContent1Charts_1 = echarts.init(document.getElementById('echRightContent1_1'));
    }
    rightContent1Charts.clear();
    rightContent1Charts.resize();
    /*rightContent1Charts_1.clear();
    rightContent1Charts_1.resize();*/
        ...
        graphic: [
            {
                ...
                left: '50%',
                style: {
                    image: '/arjccm/static/common/index/images/statIndexZj/xmzj_bg11.png',
                }
            },
