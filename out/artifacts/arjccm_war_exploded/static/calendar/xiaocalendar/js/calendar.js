(function(root, factory) {
    ...
    var defaults = {
        ...
        TEMPLATE = [
            ...
            '<ol style="margin: 0" class="week">{week}</ol>',
    ...
    Calendar.prototype = {
        ...
        hasLabel: function() {
            if (this.options.label) {
                $('#calendarBody').append(this.$label);
                return true;
            }
            return false;
        },
        event: function() {
            var _this = this,
             ...
             arr1 = _this.getDisDateValue(),
            y1 = arr1[0],
            m1 = arr1[1];
                
        var d1 = _this.updateDateView(y1, m1, "prev", function() {
            vc('date', d1.y, d1.m);
        });
            
        arr2 = _this.getDisDateValue(),
        y2 = arr2[0],
        m2 = arr2[1];
        var d2 = _this.updateDateView(y2, m2, "next", function() {
            vc('date', d2.y, d2.m);
        });
            ...
            _this.$element.on('click', DISPLAY_VD, function() {
             ...
             _this.$element.on('load', ARROW_DATE, function() {
            	
                var arr = _this.getDisDateValue(),
                    y = arr[0],
                    m = arr[1];
                       
                var d = _this.updateDateView(y, m, "next", function() {
                    vc('date', d.y, d.m);
                });
            ...
            _this.$element.on('mouseenter', '[' + ITEM_DAY + ']', function(e) {
                ...
                if (_this.hasLabel && $(this).data(MARK_DATA)) {
                    $('#calendarBody').append(_this.$label);
