...
function jingwushiFun(_this){
	...
	var Data={
			"type": "FeatureCollection",
			"centpoint": [113.35469041526576,34.528446678667756],
			"features": [{
				"type": "Feature",  
				...
				"properties": {
					...
					"coordinateCentre": [113.35469041526576,34.528446678667756],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.35469041526576,34.528446678667756],
							[113.35469041526576,34.528446678667756],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "02c24f6e637942a48557ae0000000042",
				"properties": {
					"name": "幸福街警务室",
					"icon": "gongan3.png",
					"type":'警务室',
					...
					"coordinateCentre": [113.3805650654662,34.54114368193948],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.3805650654662,34.54114368193948],
							[113.3805650654662,34.54114368193948],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "02c24f6e637942a48557ae0000000043",
				"properties": {
					"name": "青峰路警务室",
					"icon": "gongan3.png",
					"type":'警务室',
					...
					"coordinateCentre": [113.38411905558362,34.544528214357335],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.38411905558362,34.544528214357335],
							[113.38411905558362,34.544528214357335],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "02c24f6e637942a48557ae0000000044",
				"properties": {
					"name": "梁沟警务室",
					"icon": "gongan3.png",
					"type":'警务室',
					...
					"coordinateCentre": [113.36285981690979,34.54386886985354],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.36285981690979,34.54386886985354],
							[113.36285981690979,34.54386886985354],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "02c24f6e637942a48557ae0000000045",
				"properties": {
					"name": "北密新路警务室",
					"icon": "gongan3.png",
					"type":'警务室',
					...
					"coordinateCentre": [113.3905830965601,34.54318487695708],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.3905830965601,34.54318487695708],
							[113.3905830965601,34.54318487695708],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "02c24f6e637942a48557ae0000000046",
				"properties": {
					"name": "赵坡警务室",
					"icon": "gongan3.png",
					"type":'警务室',
					...
					"coordinateCentre": [113.41881474930915,34.53355659857219],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.41881474930915,34.53355659857219],
							[113.41881474930915,34.53355659857219],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "02c24f6e637942a48557ae0000000047",
				"properties": {
					"name": "五里店警务室",
					"icon": "gongan3.png",
					"type":'警务室',
					...
					"coordinateCentre": [113.38776393664902,34.52046213996873],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.38776393664902,34.52046213996873],
							[113.38776393664902,34.52046213996873],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "02c24f6e637942a48557ae0000000048",
				"properties": {
					"name": "民康路警务室",
					"icon": "gongan3.png",
					"type":'警务室',
					...
					"coordinateCentre": [113.39277372245823,34.537142939704985],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.39277372245823,34.537142939704985],
							[113.39277372245823,34.537142939704985],
						]
					]
				}
	...
	Map1.goTo([113.35469041526576,34.528446678667756])
	}else{
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000041Overlay'])
		map.removeOverlay(thisMap['02c24f6e637942a48557ae0000000042Overlay'])
		map.removeOverlay(thisMap['02c24f6e637942a48557ae0000000043Overlay'])
		map.removeOverlay(thisMap['02c24f6e637942a48557ae0000000044Overlay'])
		map.removeOverlay(thisMap['02c24f6e637942a48557ae0000000045Overlay'])
		map.removeOverlay(thisMap['02c24f6e637942a48557ae0000000046Overlay'])
		map.removeOverlay(thisMap['02c24f6e637942a48557ae0000000047Overlay'])
		map.removeOverlay(thisMap['02c24f6e637942a48557ae0000000048Overlay'])
...
function gongzuozhanFun(_this){
	...
	var Data={
			...
			"features": [{
				...
				"type": "Feature",  
				"id": "02c24f6e637942a48557ae0000000092",
				"properties": {
					"name": "开阳路警务工作站",
					"icon": "gongan3.png",
					"type":'工作站',
					...
					"coordinateCentre": [113.36879699849305,34.54406297594578],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.36879699849305,34.54406297594578],
							[113.36879699849305,34.54406297594578],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "02c24f6e637942a48557ae0000000093",
				"properties": {
					"name": "气象街警务工作站",
					"icon": "gongan3.png",
					"type":'工作站',
					...
					"coordinateCentre": [113.3710769748146,34.53347649129602],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.3710769748146,34.53347649129602],
							[113.3710769748146,34.53347649129602],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "02c24f6e637942a48557ae0000000094",
				"properties": {
					"name": "方寨警务工作站",
					"icon": "gongan3.png",
					"type":'工作站',
					...
					"coordinateCentre": [113.3745523981804,34.53387086557867],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.3745523981804,34.53387086557867],
							[113.3745523981804,34.53387086557867],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "02c24f6e637942a48557ae0000000095",
				"properties": {
					"name": "杨寨警务工作站",
					"icon": "gongan3.png",
					"type":'工作站',
					...
					"coordinateCentre": [113.39383360334286,34.509339552778506],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.39383360334286,34.509339552778506],
							[113.39383360334286,34.509339552778506],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "02c24f6e637942a48557ae0000000096",
				"properties": {
					"name": "嵩山路警务工作站",
					"icon": "gongan3.png",
					"type":'工作站',
					...
					"coordinateCentre": [113.38895322159512,34.53006885101004],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.38895322159512,34.53006885101004],
							[113.38895322159512,34.53006885101004],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "02c24f6e637942a48557ae0000000097",
				"properties": {
					"name": "石庙沟社区警务工作站",
					"icon": "gongan3.png",
					"type":'工作站',
					...
					"coordinateCentre": [113.38880533123913,34.538473952908916],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.38880533123913,34.538473952908916],
							[113.38880533123913,34.538473952908916],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "02c24f6e637942a48557ae0000000098",
				"properties": {
					"name": "北密新路警务工作站",
					"icon": "gongan3.png",
					"type":'工作站',
	...
	$(_this).css('border','1px solid #0e54a9')
		...
		map.removeOverlay(thisMap['02c24f6e637942a48557ae0000000092Overlay'])
		map.removeOverlay(thisMap['02c24f6e637942a48557ae0000000093Overlay'])
		map.removeOverlay(thisMap['02c24f6e637942a48557ae0000000094Overlay'])
	    map.removeOverlay(thisMap['02c24f6e637942a48557ae0000000095Overlay'])
	    map.removeOverlay(thisMap['02c24f6e637942a48557ae0000000096Overlay'])
	    map.removeOverlay(thisMap['02c24f6e637942a48557ae0000000097Overlay'])
		map.removeOverlay(thisMap['02c24f6e637942a48557ae0000000098Overlay'])
		$(_this).css('border','1px solid transparent')
...
function binguanFun(_this){
	var Data={
			...
			"features": [{   
				...
				"type": "Feature",
				"id": "02c24f6e637942a48557af0000000021",
				"properties": {
					"name": "金斯顿主题酒店",
					"icon": "binguan3.png",
					"info": {
					...
					"coordinateCentre": [113.35627099344543,34.5370766971497]
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.35627099344543,34.5370766971497],
							[113.35627099344543,34.5370766971497]
						]
					]
				}
	...
	Map1.goTo(["113.34798143088717", "34.5374695309078"])
		...
		map.removeOverlay(thisMap['02c24f6e637942a48557af0000000021Overlay'])
		$(_this).css('border','1px solid transparent')
...
function xuexiaoFun(_this){
	var Data={
			...
			"features": [  {
				...
				"type": "Feature",
				"id": "03c24f6e637942a48557af0000000101",
				"properties": {
					"name": "新密市第三小学",
					"icon": "xuexiao3.png",
					"info": {
					...
					"coordinateCentre": [113.36635988866826,34.53511869045735]
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.36635988866826,34.53511869045735],
							[113.36635988866826,34.53511869045735],
						]
					]
				}
	...
	Map1.goTo(["113.33587660524924", "34.54076009132863"])
		...
		map.removeOverlay(thisMap['03c24f6e637942a48557af0000000101Overlay'])
		$(_this).css('border','1px solid transparent')
...
function yiyuanFun(_this){
	var Data={
			...
			"features": [{
				...
				"type": "Feature",
				"id": "02c24f6e637942a48557af0000000101",
				"properties": { 
					"name": "新密市中医院",
					"icon": "yiyuan3.png",
					"info": {
					...
					"coordinateCentre": [113.34853601972216,34.528817945082274],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.34853601972216,34.528817945082274],
							[113.34853601972216,34.528817945082274],
						]
					]
				}
				...
				"type": "Feature",
				"id": "02c24f6e637942a48557af0000000102",
				"properties": { 
					"name": "第一人民医院",
					"icon": "yiyuan3.png",
					"info": {
					...
					"coordinateCentre": [113.37610216586923,34.53853249284149],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.37610216586923,34.53853249284149],
							[113.37610216586923,34.53853249284149],
						]
					]
				}
				...
				"type": "Feature",
				"id": "02c24f6e637942a48557af0000000103",
				"properties": { 
					"name": "老年病医院",
					"icon": "yiyuan3.png",
					"info": {
					...
					"coordinateCentre": [113.35866959015668,34.53453329113155],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.35866959015668,34.53453329113155],
							[113.35866959015668,34.53453329113155],
						]
					]
				}
	...
	Map1.goTo(["113.36576216514614", "34.531276006040834"])
		...
		map.removeOverlay(thisMap['02c24f6e637942a48557af0000000101Overlay'])
		map.removeOverlay(thisMap['02c24f6e637942a48557af0000000102Overlay'])
		map.removeOverlay(thisMap['02c24f6e637942a48557af0000000103Overlay'])
		$(_this).css('border','1px solid transparent')
...
function jingcheFun(_this){
	var Data={
			...
			"features": [{
				...
				"type": "Feature",
				"id": "01c24f6e637942a48557af0000000133",
				"properties": { 
					"name": "豫A0513H",
					"icon": "c1.png",
					"src":"",
					...
					"coordinateCentre": [113.35578264716577,34.53907167643105],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.35578264716577,34.53907167643105],
							[113.35578264716577,34.53907167643105],
						]
					]
				}
				...
				"type": "Feature",
				"id": "01c24f6e637942a48557af0000000134",
				"properties": { 
					"name": "豫A0511H",
					"icon": "c1.png",
					"src":"",
					...
					"coordinateCentre": [113.35577032296943,34.53819665849143],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.35577032296943,34.53819665849143],
							[113.35577032296943,34.53819665849143],
						]
					]
				}
				...
				"type": "Feature",
				"id": "01c24f6e637942a48557af0000000135",
				"properties": { 
					"name": "豫A0510H",
					"icon": "c1.png",
					"src":"",
					...
					"coordinateCentre": [113.35917180115725,34.5351649061936],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.35917180115725,34.5351649061936],
							[113.35917180115725,34.5351649061936],
						]
					]
				}
				...
				"type": "Feature",
				"id": "01c24f6e637942a48557af0000000136",
				"properties": { 
					"name": "豫A3410H",
					"icon": "c1.png",
					"src":"",
					...
					"coordinateCentre": [113.3589746140159,34.53400643173833],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.3589746140159,34.53400643173833],
							[113.3589746140159,34.53400643173833],
						]
					]
				}
	...
	Map1.goTo(["113.35671620503794", "34.53728590038246"])
		...
		map.removeOverlay(thisMap['01c24f6e637942a48557af0000000133Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557af0000000134Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557af0000000135Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557af0000000136Overlay'])
		$(_this).css('border','1px solid transparent')
...
function jiayouzhanFun(_this){
	var Data={
			...
			"features": [{
				...
				"type": "Feature",  
				"id": "02c24f6e637942a48557ae0000000111",
				"properties": {
					"name": "中国石化(气象街)",
					"icon": "jiayouzhan3.png",
					"info": {
					...
					"coordinateCentre": [113.36986920357398,34.53217012648476],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							 [113.36986920357398,34.53217012648476],
							 [113.36986920357398,34.53217012648476],
						]
					]
				}
	...
	Map1.goTo(["113.37127662679515", "34.53244865332188"])
		...
		map.removeOverlay(thisMap['02c24f6e637942a48557ae0000000111Overlay'])
		$(_this).css('border','1px solid transparent')
...
function shipinjiankongFun(_this){
	var Data={
			"type": "FeatureCollection",
			"centpoint": [113.35994052290349,34.53765901542642],
			"features": [{  
				"type": "Feature",  
				...
				"properties": {
					...
					"coordinateCentre": ["113.3600083059833", "34.53722458750568"],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							["113.3600083059833", "34.53722458750568"],
							["113.3600083059833", "34.53722458750568"],
						]
					]
				}
				...
				"properties": {
					...
					"coordinateCentre": [113.35994052290349,34.53765901542642],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.35994052290349,34.53765901542642],
							[113.35994052290349,34.53765901542642],
						]
					]
				}
				...
				"properties": {
					...
					"coordinateCentre": [113.36050281436117,34.53762974546013],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							 [113.36050281436117,34.53762974546013],
							 [113.36050281436117,34.53762974546013],
						]
					]
				}
				...
				"properties": {
					...
					"coordinateCentre": [113.36053978695017,34.537247695373814],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.36053978695017,34.537247695373814],
							[113.36053978695017,34.537247695373814],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "01c24f6e637942a48557ae0000000128",
				"properties": {
					"name": "视频监控4",
					"icon": "video.png",
					"src":"video3.mp4",
					...
					"coordinateCentre": [113.35898693821225,34.537642069656464],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
						[113.35898693821225,34.537642069656464],
						[113.35898693821225,34.537642069656464],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "01c24f6e637942a48557ae0000000130",
				"properties": {
					"name": "视频监控4",
					"icon": "video.png",
					"src":"video3.mp4",
					...
					"coordinateCentre": [113.35912250437191,34.53639732582686],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.35912250437191,34.53639732582686],
							[113.35912250437191,34.53639732582686],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "01c24f6e637942a48557ae0000000131",
				"properties": {
					"name": "视频监控4",
					"icon": "video.png",
					"src":"video3.mp4",
					...
					"coordinateCentre": [113.35803797509463,34.537642069656464],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.35803797509463,34.537642069656464],
							[113.35803797509463,34.537642069656464],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "01c24f6e637942a48557ae0000000132",
				"properties": {
					"name": "视频监控4",
					"icon": "video.png",
					"src":"video3.mp4",
					...
					"coordinateCentre": [113.357458737867,34.537247695373814],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.357458737867,34.537247695373814],
							[113.357458737867,34.537247695373814],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "01c24f6e637942a48557ae0000000133",
				"properties": {
					"name": "视频监控4",
					"icon": "video.png",
					"src":"video3.mp4",
					...
					"coordinateCentre": [113.35524038252711,34.53780228420879],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.35524038252711,34.53780228420879],
							[113.35524038252711,34.53780228420879],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "01c24f6e637942a48557ae0000000134",
				"properties": {
					"name": "视频监控4",
					"icon": "video.png",
					"src":"video3.mp4",
					...
					"coordinateCentre": [113.36150107426411,34.537642069656464],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.36150107426411,34.537642069656464],
							[113.36150107426411,34.537642069656464],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "01c24f6e637942a48557ae0000000135",
				"properties": {
					"name": "视频监控4",
					"icon": "video.png",
					"src":"video3.mp4",
					...
					"coordinateCentre": [113.36233911961473,34.53767904224546],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.36233911961473,34.53767904224546],
							[113.36233911961473,34.53767904224546],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "01c24f6e637942a48557ae0000000136",
				"properties": {
					"name": "视频监控4",
					"icon": "video.png",
					"src":"video3.mp4",
					...
					"coordinateCentre": [113.36343597308834,34.53769136644179],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.36343597308834,34.53769136644179],
							[113.36343597308834,34.53769136644179],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "01c24f6e637942a48557ae0000000137",
				"properties": {
					"name": "视频监控4",
					"icon": "video.png",
					"src":"video3.mp4",
					...
					"coordinateCentre": [113.36397823772698,34.53708748082149],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.36397823772698,34.53708748082149],
							[113.36397823772698,34.53708748082149],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "01c24f6e637942a48557ae0000000138",
				"properties": {
					"name": "视频监控4",
					"icon": "video.png",
					"src":"video3.mp4",
					...
					"coordinateCentre": [113.36399056192332,34.53809806492077],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.36399056192332,34.53809806492077],
							[113.36399056192332,34.53809806492077],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "01c24f6e637942a48557ae0000000139",
				"properties": {
					"name": "视频监控4",
					"icon": "video.png",
					"src":"video3.mp4",
					...
					"coordinateCentre": [113.36376872638932,34.53897308286039],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.36376872638932,34.53897308286039],
							[113.36376872638932,34.53897308286039],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "01c24f6e637942a48557ae0000000140",
				"properties": {
					"name": "视频监控4",
					"icon": "video.png",
					"src":"video3.mp4",
					...
					"coordinateCentre": [113.36383034737099,34.54013155731566],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.36383034737099,34.54013155731566],
							[113.36383034737099,34.54013155731566],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "01c24f6e637942a48557ae0000000141",
				"properties": {
					"name": "视频监控4",
					"icon": "video.png",
					"src":"video3.mp4",
					...
					"coordinateCentre": [113.36439726040228,34.54064917356163],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.36439726040228,34.54064917356163],
							[113.36439726040228,34.54064917356163],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "01c24f6e637942a48557ae0000000142",
				"properties": {
					"name": "视频监控4",
					"icon": "video.png",
					"src":"video3.mp4",
					...
					"coordinateCentre": [113.36241306479273,34.54030409606432],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.36241306479273,34.54030409606432],
							[113.36241306479273,34.54030409606432],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "01c24f6e637942a48557ae0000000143",
				"properties": {
					"name": "视频监控4",
					"icon": "video.png",
					"src":"video3.mp4",
					...
					"coordinateCentre": [1113.36140248069346,34.54021782668999],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[1113.36140248069346,34.54021782668999],
							[1113.36140248069346,34.54021782668999],
						]
					]
				}
				...
				"type": "Feature",  
				"id": "01c24f6e637942a48557ae0000000144",
				"properties": {
					"name": "视频监控4",
					"icon": "video.png",
					"src":"video3.mp4",
					...
					"coordinateCentre": [113.36039189659418,34.54099425105895],
				},
				"geometry": {
					"type": "Polygon",
					"coordinates": [
						[
							[113.36039189659418,34.54099425105895],
							[113.36039189659418,34.54099425105895],
						]
					]
				}
	...
	Map1.goTo(["113.3593930204814", "34.53745535808203"])
		...
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000128Overlay'])
	
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000130Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000131Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000132Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000133Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000134Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000135Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000136Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000137Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000138Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000139Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000140Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000141Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000142Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000143Overlay'])
		map.removeOverlay(thisMap['01c24f6e637942a48557ae0000000144Overlay'])
		$(_this).css('border','1px solid transparent')
...
function XiangQingFun(type){
	...
	var XiangQingData={
			"长乐路警务室":{
	            ...
	            "辅警":[{'姓名':'蒋尚涵','警号':'103805','性别':'男','电话':'13674919298',"src":'jiangshanghan.jpg'},{'姓名':'李格','警号':'103806','性别':'女','电话':'13509856056',"src":'lige.JPG'},{'姓名':'许伟强','警号':'103807','性别':'男','电话':'13603986786',"src":'xuxiaowu.jpg'}]
				},
			"于家岗警务工作站":{
				"民警":[{'姓名':'慕观卿','警号':'103802','性别':'男','电话':'17603711723',"src":'muguanqing.JPG'}],
	            "辅警":[]
				},
			"嵩阳路警务工作站":{
				"民警":[{'姓名':'蒋尚涵','警号':'103805','性别':'男','电话':'13674919298',"src":'jiangshanghan.jpg'}],
	            "辅警":[]
				},
			"广场警务工作站":{
				"民警":[],
	            "辅警":[{'姓名':'高志阳','警号':'103815','性别':'男','电话':'15136205957',"src":'gaozhiyang.jpg'}]
				}
			}
