...
public class SearchTabMM extends SearchTabMore {
	...
	public String getValue22() {
		return StringUtils.isEmpty(value22) ? "0" : value22;
	}
	...
	public String getValue23() {
		return StringUtils.isEmpty(value23) ? "0" : value23;
	}
	...
	public String getValue24() {
		return StringUtils.isEmpty(value24) ? "0" : value24;
	}
	...
	public String getValue25() {
		return StringUtils.isEmpty(value25) ? "0" : value25;
	}
	...
	public String getValue26() {
		return StringUtils.isEmpty(value26) ? "0" : value26;
	}
	...
	public String getValue27() {
		return StringUtils.isEmpty(value27) ? "0" : value27;
	}
	...
	public String getValue28() {
		return StringUtils.isEmpty(value28) ? "0" : value28;
	}
	...
	public String getValue29() {
		return StringUtils.isEmpty(value29) ? "0" : value29;
	}
	...
	public String getValue30() {
		return StringUtils.isEmpty(value30) ? "0" : value30;
	}
