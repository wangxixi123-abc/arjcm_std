...
public class ImportUserVCcmTeam extends DataEntity<com.arjjs.ccm.modules.sys.entity.User> {
    ...
    public ImportUserVCcmTeam() {
        this.loginFlag = "1";
    }

    public ImportUserVCcmTeam(String id) {
        super(id);
    }

    public ImportUserVCcmTeam(String id, String loginName) {
        super(id);
        this.loginName = loginName;
    }

    public ImportUserVCcmTeam(Role role) {
        this.role = role;
    }
