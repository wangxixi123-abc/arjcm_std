...
$(function () {
    ...
    PartsDamagedEchartsFun();
    CityPartsDamagedEchartsFun();
    //地图
    map();
    PartsLoseEchartsFun();
    //城市部件丢失率TOP5
   CityPartsLoseEchartsFun();

})
//部件破损率
function PartsDamagedEchartsFun(){
    var option = {
        tooltip: {
            show: "true",
            trigger: 'axis',
    ...
    var myChart = echarts.init(document.getElementById('PartsDamagedEcharts'));
...
function CityPartsDamagedEchartsFun(){

    var myChart = echarts.init(document.getElementById('CityPartsDamagedEcharts'));
    var data = [
        {
        value: 90,
        name: '西苑社区'
...
function PartsLoseEchartsFun(){
    ...
    var myChart = echarts.init(document.getElementById('PartsLoseEcharts'));
    myChart.setOption(option);
}
//城市部件丢失率TOP5
function CityPartsLoseEchartsFun(){
    ...
    var myChart = echarts.init(document.getElementById('CityPartsLoseEcharts'));
    myChart.setOption(option, true);
}