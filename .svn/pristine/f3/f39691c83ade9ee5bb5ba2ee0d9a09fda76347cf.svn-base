...
public class CcmHouseBuildentrance extends DataEntity<CcmHouseBuildentrance> {
	private static final long serialVersionUID = 1L;
	private CcmHouseBuildmanage buildingId;//建筑物记录
	private Integer entranceNum;//单元编号【在楼宇/小区中的编号】
