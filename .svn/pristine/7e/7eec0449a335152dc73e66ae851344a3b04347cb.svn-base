...
public class CcmPeopleExport extends DataEntity<CcmPeopleExport>  {
	...
	@ExcelField(title="楼栋总层数", align=2, sort=23)
	...
	@ExcelField(title="房屋楼层", align=2, sort=24)
	...
	public CcmPeopleExport() {
		super();
	}

	public CcmPeopleExport(String id){
		super(id);
	}
...
//	@ExcelField(title="职业", align=2, sort=13)
	...
	@ExcelField(title="户籍地", align=2, sort=27)
...
//	@ExcelField(title="现住地", align=2, sort=16)
	...
	@ExcelField(title="所属社区", align=2, sort=18)
	...
	@ExcelField(title="所属网格", align=2, sort=19)
...
//	@ExcelField(title="所属楼栋", value="buildId.buildname", align=2, sort=18)
	...
	@ExcelField(title="所属楼栋", align=2, sort=20)
	...
	@ExcelField(title="楼栋单元总数", align=2, sort=21)
	...
	@ExcelField(title="所属单元", align=2, sort=22)
	...
	@ExcelField(title="所属房屋", align=2, sort=25)
...
//	@ExcelField(title="所属房屋", align=2, sort=19)
	...
	@ExcelField(title="户号", align=2, sort=26)
	...
	@ExcelField(title="所在楼栋中心点", align=2, sort=29)
	...
	@ExcelField(title="户主公民身份号码", align=2, sort=28)
...
//	@ExcelField(title="预计离开日期", align=2, sort=62)
	...
	@ExcelField(title="特殊关怀类型", align=2, sort=16)
	...
	@ExcelField(title="是否常住", align=2, sort=17, dictType="yes_no")
