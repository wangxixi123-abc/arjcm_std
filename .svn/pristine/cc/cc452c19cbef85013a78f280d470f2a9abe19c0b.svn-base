...
<script type="text/javascript">
    ...
    $("#${id}Button, #${id}Name").click(function(){
        ...
        var UrlType = "";
        if(patorlTimeType !=""){
            UrlType ="iframe:${ctx}/tag/newtreeselect?url="+encodeURIComponent("${url}")+"&module="+patorlTimeType+"&checked=${checked}&extId=${extId}&isAll=${isAll}";
        }else{
            UrlType= "iframe:${ctx}/tag/newtreeselect?url="+encodeURIComponent("${url}")+"&module=${module}&checked=${checked}&extId=${extId}&isAll=${isAll}";
        }
        // 正常打开
